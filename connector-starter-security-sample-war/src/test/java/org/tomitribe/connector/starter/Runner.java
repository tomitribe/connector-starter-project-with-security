...
public class Runner {
    ...
    public static EnterpriseArchive createDeployment() {
        ...
        final ConfigProperty<Resourceadapter<ConnectorDescriptor>> usernameProperty = raXml.getOrCreateResourceadapter().createConfigProperty();
        usernameProperty.configPropertyName("username");
        usernameProperty.configPropertyType("String");
        usernameProperty.configPropertyValue("tomee");

        final ConfigProperty<Resourceadapter<ConnectorDescriptor>> passwordProperty = raXml.getOrCreateResourceadapter().createConfigProperty();
        passwordProperty.configPropertyName("password");
        passwordProperty.configPropertyType("String");
        passwordProperty.configPropertyValue("tomee");
